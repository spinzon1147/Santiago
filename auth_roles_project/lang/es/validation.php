...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña proporcionada aparece en una filtración de datos. Elige una contraseña diferente.',
    ],
    ...
    'attributes' => [
        ...
        'Direc_Cli' => 'dirección del cliente',
        'Estado_Cli' => 'estado del cliente',
        'Nom_Prov' => 'nombre del proveedor',
        'Tel_Prov' => 'teléfono del proveedor',
        'Direc_Prov' => 'dirección del proveedor',
        'Estado_Prov' => 'estado del proveedor',
        'Nom_pro' => 'nombre del producto',
        'Cant_pro' => 'cantidad',
        'Precio_pro' => 'precio',
        'Estado_pro' => 'estado',
        'Descrip_pro' => 'descripción',
        'Cant_Ven' => 'cantidad vendida',
        'Total_Ven' => 'total',
        'Fecha_Ven' => 'fecha de venta',
        'Id_Prod_FK' => 'producto',
        'Valor_Com' => 'valor',
        'Fecha_Com' => 'fecha de compra',
        'Cant_Com' => 'cantidad comprada',
        'Precio_Com' => 'precio de compra',
